...
ALL_ERROR["10019"] = {
    "error_code": "10019",
    "error_msg": "scan code fault",
    "zh_msg": "笼车空箱回收影像异常,无法获取空箱信息,处理料箱后,重新连接机器人节点，然后点开始运行程序",
...
ALL_ERROR["10021"] = {
    ...
    "error_msg": "拣配算法计算超时",
    "zh_msg": "拣配算法计算超时",
    "tip": "大概率是需要拣配的箱子干涉无法抓取,请将相邻的高列和低列稍微隔开,在hmi初始化节点,重新连接机器人节点，然后点开始运行程序",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
    "en_tip": "已自动回报WCS虚拟储位匹配失败",
...
ALL_ERROR["10022"] = {
    ...
    "error_msg": "视觉初步检测到碰撞",
    "zh_msg": "视觉初步检测到碰撞",
    "tip": "视觉检测到碰撞,查看HMI自定义功能上的拍照图片,将交叉的框体稍微隔开,在hmi初始化节点,重新连接机器人节点，然后点开始运行程序",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
    "en_tip": "已自动回报WCS虚拟储位匹配失败",
...
ALL_ERROR["10023"] = {
    "error_code": "10023",
    "error_msg": "笼车空箱回收任务,扫码给出错误的信息",
    "zh_msg": "笼车空箱回收任务,扫码给出错误的信息",
    "tip": "手动打开夹具松开料箱,将料箱取走,机器人摇到初始位置,在hmi初始化节点,重新连接机器人节点，然后点开始运行程序",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
    "en_tip": "已自动回报WCS虚拟储位匹配失败",
...
ALL_ERROR["10024"] = {
    "error_code": "10024",
    "error_msg": "笼车空箱回收任务,无法识别区分大欧还是中欧",
    "zh_msg": "笼车空箱回收任务,无法识别区分大欧还是中欧",
    "tip": "将笼车上的料箱摆动分开下,在hmi初始化节点,重新连接机器人节点，然后点开始运行程序",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
    "en_tip": "已自动回报WCS虚拟储位匹配失败",
...
ALL_ERROR["10026"] = {
    "error_code": "10026",
    "error_msg": "来料托盘定位偏差过大",
    "zh_msg": "来料托盘定位偏差过大",
    "tip": "手动把托盘摆正,在hmi初始化节点,重新连接机器人节点，然后点开始运行程序",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
    "en_tip": "已自动回报WCS虚拟储位匹配失败",
...
ALL_ERROR["10027"] = {
    "error_code": "10027",
    "error_msg": "笼车空箱回收,输送线-托盘运动规划失败",
    "zh_msg": "笼车空箱回收,输送线-托盘运动规划失败",
    "tip": "检查托盘定位精度，大概率是托盘定位导致已经码不进去了，看情况使用辅助功能通知JCS码满拖走",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
    "en_tip": "已自动回报WCS虚拟储位匹配失败",
...
ALL_ERROR["10028"] = {
    "error_code": "10028",
    "error_msg": "输送线空箱回收,输送线-托盘运动规划失败",
    "zh_msg": "输送线空箱回收,输送线-托盘运动规划失败",
    "tip": "检查托盘定位精度，大概率是托盘定位导致已经码不进去了，看情况使用辅助功能通知JCS码满拖走",
    "ja_msg": "位置号匹配失败",
    "ja_tip": "已自动回报WCS虚拟储位匹配失败",
    "en_msg": "位置号匹配失败",
...
ALL_ERROR["E0800"] = {
    ...
    "zh_msg": "夹具异常：检测或控制失败",
    "tip": "1）请排查夹具检测或控制异常；2）如果夹具已经抓取料箱，请将料箱放回抓取位置",
