...
#后围栏
collision_15 = build_collision(name="col_15", origin=[-2.84, 0, -0.32+1.5/2, 0, 0, 0, 1], dimensions=[0.11, 6,5.3+1.5], geometric_type=GeometricPrimitive.BOX, alpha=0.2)
# #后围栏
...
tip_primitive_1 = bulid_tip_primitive(tool_name = tool_name, id="tp_1", tf_tool_region=([0.13064,
 -0.00096,
 0.7646,
 0.0,
 -0.0,
