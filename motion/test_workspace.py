...
#机器人底座1.605m
# 拣配来料空间0-码垛托盘0
ws0 = build_workspace(workspace_id="0", bottom_pose=[-0.15+0.02, 1.85+0.03, -1.121, 0.0, 0.0, 0.0, 1], dimensions=[1.25, 1.05+0.2, 1.65], ws_type="pallet")
pallet_0 = build_pallet(name="pallet_0", top_origin=[-0.15+0.02, 1.85+0.03, -1.121-0.04, 0.0, 0.0, 0.0, 1], dimensions=[1.25, 1.05+0.2, 0.15+0.334])
ws0.pallet = pallet_0


# 缓存区1-码垛托盘1
ws1 = build_workspace(workspace_id="1", bottom_pose=[-2, 1.1, -1.121-0.007, 0.0, 0.0, 0.707, 0.707], dimensions=[1.25, 1.05, 1.65], ws_type="pallet")
pallet_1 = build_pallet(name="pallet_1", top_origin=[-2, 1.1, -1.121-0.007-0.04, 0.0, 0.0, 0.707, 0.707], dimensions=[1.2, 1.0, 0.15+0.334])
ws1.pallet = pallet_1

#笼车空间2-码垛托盘2
ws2 = build_workspace(workspace_id="2", bottom_pose=[1.6+0.1, 1.65, -1.267-0.015, 0.0, 0.0, 0.707, 0.707], dimensions=[1.22, 0.815, 1.62], ws_type="pallet")
pallet_2 = build_pallet(name="pallet_2", top_origin=[1.6+0.1, 1.65, -1.267-0.015-0.04, 0.0, 0.0, 0.707, 0.707], dimensions=[1.22, 0.815, 0.33])
ws2.pallet = pallet_2
...
#码垛托盘4
ws4 = build_workspace(workspace_id="4", bottom_pose=[-2, -0.9, -1.121, 0.0, 0.0, 0.707, 0.707], dimensions=[1.25, 1.05, 1.65], ws_type="pallet")
pallet_4 = build_pallet(name="pallet_4", top_origin=[-2, -0.9, -1.121-0.04, 0.0, 0.0, 0.707, 0.707], dimensions=[1.2, 1.0, 0.15+0.334])
ws4.pallet = pallet_4
...
#输送线6
ws6 = build_workspace(workspace_id="6", bottom_pose=[1.14+0.008, -1.818+0.035, -1, 0.0, 0.0, 0.707, 0.707], dimensions=[0.61, 0.41, 0.6], ws_type="conveyor")
conveyor_6 = build_conveyor(name="conveyor_6", top_origin=[1.14+0.008, -2.221, -1, 0.0, 0.0, 0.707, 0.707], dimensions=[2, 0.45, 0.5], side_height=0.12, side_width=0.01)
...
tip_primitive_1 = bulid_tip_primitive(tool_name = tool_name, id="tp_1", tf_tool_region=(0.13107,
 ...
 0.0,
 0.70710678,
 0.70710678), dimension=[0.4, 0.3], max_suction_force=150)
...
combined_tool_collision.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.4-0.015, 0.6-0.015, 0.65], relative_pose=Pose(0.13207-0.3/2,
 0,
 0.1+0.65/2-0.03,
 0.0,
 0.0,
...
clamp_collision_body.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.4-0.015, 0.6-0.015, 0.65], relative_pose=Pose(0.13207-0.3/2,
 0,
 0.1+0.65/2-0.03,
 0.0,
 0.0,
...
clamp_collision_name.append("body")
 ...
 #夹具大本体上半部分
combined_tool_collision.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.4-0.015, 0.7, 0.3+0.2], relative_pose=Pose(0.13207-0.5/2,
 0,
 0.1+0.3/2+0.2/2,
 0.0,
 0.0,
...
clamp_collision_body.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.4-0.015, 0.7, 0.3], relative_pose=Pose(0.13207-0.5/2,
 0,
 0.08+0.3/2+0.2/2,
 0.0,
 0.0,
...
clamp_collision_1.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.24+0.1, 0.11, 0.15+0.3], relative_pose=Pose(0.157-0.008-0.1/2, 0.249+0.05, 0.660+0.1-0.3/2, 0, 0, 0, 1)))
clamp_collision_list.append(clamp_collision_1)
clamp_collision_name.append("+y")

combined_tool_collision.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.24+0.1, 0.11, 0.25+0.3], relative_pose=Pose(0.157-0.008-0.1/2, 0.249+0.05, 0.660+0.1-0.3/2, 0, 0, 0, 1)))
