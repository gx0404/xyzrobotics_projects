...
def execute(self, inputs, outputs, gvm):
    ...
    list(map(lambda info: info.update({"sku_info": sku_info}), results))
    ...
    l, w, h = sku_info["length"], sku_info["width"], sku_info["height"]
