...
def execute(self, inputs, outputs, gvm):
    ...
    try:    
        ...
        raise XYZExceptionBase("10013", "OpenCameraFailed")
    ...
    solver_config.safety_distance.at_goal = 0.05
    solver_config.safety_distance.at_start = 0.03    
