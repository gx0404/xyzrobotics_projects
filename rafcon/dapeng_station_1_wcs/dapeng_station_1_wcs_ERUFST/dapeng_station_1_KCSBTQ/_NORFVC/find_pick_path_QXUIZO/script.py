...
def execute(self, inputs, outputs, gvm):
   ...
   if direction==current_direction:
      ...
      self.logger.info(f"current_direction is {current_direction},change_direction is {direction}")
      outputs["change_direction"] = direction
      gvm.set_variable("plan_path", None, per_reference=False)
