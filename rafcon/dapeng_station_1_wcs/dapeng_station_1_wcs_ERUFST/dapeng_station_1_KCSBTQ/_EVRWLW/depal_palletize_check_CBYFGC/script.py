    ...
    for container_item in pick_container_items:
        ...
        if box_id in pallet_tote_data.keys():
            ...
            if row==5:
                ...
                lay_id = int(box_id)//row
                if row_id in [1,2]:
                    tf_base_box_real = tf_base_box_real*SE3([-0.001,0.0025,0,0,0,0,1]) 
                elif row_id in [3,4]:     
                    tf_base_box_real = tf_base_box_real*SE3([-0.001,0.0015,0,0,0,0,1]) 
                elif row_id in [5,6]: 
                    tf_base_box_real = tf_base_box_real*SE3([-0.002,0.003,0,0,0,0,1])                          
                elif row_id in [7]:
                    tf_base_box_real = tf_base_box_real*SE3([-0.006,-0.002,0,0,0,0,1])   
                elif row_id in [8]:
                    tf_base_box_real = tf_base_box_real*SE3([0.003,-0.002,0,0,0,0,1])                       
                elif row_id in [0]:
