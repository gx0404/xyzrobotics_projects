...
def execute(self, inputs, outputs, gvm):
    ...
    our_robot_msg.tool.tool_collisions.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.70-0.11, 0.50-0.06, 0.65], relative_pose=Pose(0, 0, 0.08+0.7/2+0.07, 0, 0, 0, 1)))
