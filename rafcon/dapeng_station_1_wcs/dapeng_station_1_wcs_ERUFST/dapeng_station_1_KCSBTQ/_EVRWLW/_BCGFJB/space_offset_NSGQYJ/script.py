...
def execute(self, inputs, outputs, gvm):
    ...
    if object_poses:
        ...
        if container_items:
            ...
            space_pose_obj_z = check_items[0].origin.z+tip_pose_z+self.smart_data["sku_max_height"]+0.15
        else:
            space_pose_obj_z = work_space_pose[2]+tip_pose_z+self.smart_data["sku_max_height"]+0.15
