...
def execute(self, inputs, outputs, gvm):
   ...
   #相机扩大一点
    ...
    # our_robot_msg.tool.tool_collisions.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.55, 0.3, 0.2], relative_pose=Pose(
    # -0.352-0.209/2, 
    # 0, 
    # 0.0835, 
    # 0, 0, 
    # 0.707, 
    # 0.707)))
    # our_robot_msg.tool.tool_collisions.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.42, 0.62, 0.7], relative_pose=Pose(
    # 0.12577481399374124-0.3/2,
    ...
    # 0.7075254540376501,
    # 0.7066782731413475)))
    # our_robot_msg.tool.tool_collisions.primitives.append(GeometricPrimitive(type=GeometricPrimitive.BOX, dimensions=[0.38, 0.7, 0.3], relative_pose=Pose(
    # 0.12577481399374124-0.5/2,
    # -0.0009011965213759901,
    # 0.08+0.3/2+0.07,
    # -0.0024977710695978537,
    # -0.0030570717793057247,
