...
def execute(self, inputs, outputs, gvm):
    ...
    def build_primitive(info,pose_dict,pallet_tote_data,pick_tote_data):
        vision_box_proxy = FormattedRealBox(id = int(info["id"]+10000), 
    ...
    for name,pose_dict in all_pose_dict.items():
        container_items = [build_primitive(info, pose_dict, pallet_tote_data, pick_tote_data) for info in results]
