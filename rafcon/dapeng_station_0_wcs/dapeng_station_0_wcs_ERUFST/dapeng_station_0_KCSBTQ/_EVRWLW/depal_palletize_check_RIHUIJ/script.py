...
def execute(self, inputs, outputs, gvm):
    ...
    for container_item in pick_container_items:
        ...
        if box_id in pallet_tote_data.keys():
            ...
            #tf_base_box_real = tf_base_box_real* SE3([0.004,0.00,0,0,0,0,1])
            #tf_base_box_real = SE3([0.006,-0.0015,0,0,0,0,1])*tf_base_box_real
            if row==5:
                tf_base_box_real = SE3([0.006,-0.003,0,0,0,0,1])*tf_base_box_real
            elif row==9:
                tf_base_box_real = SE3([0.005,-0.005,0,0,0,0,1])*tf_base_box_real 
                #tf_base_box_real = tf_base_box_real* SE3([-0.005,0.00,0,0,0,0,1])    
            else:
                raise "无效的row"    
