...
def execute(self, inputs, outputs, gvm):
    ...
    #通过抓取计算得到的路径，指定抓取箱子
    merge_pick_path = gvm.get_variable("merge_pick_path", per_reference=False, default=None)
    pick_item_id = merge_pick_path[0]
    ...
    self.logger.info(f"grasp plan 已规划出指定箱子{merge_pick_path[0]},更新路径")
    merge_pick_path.pop(0)
