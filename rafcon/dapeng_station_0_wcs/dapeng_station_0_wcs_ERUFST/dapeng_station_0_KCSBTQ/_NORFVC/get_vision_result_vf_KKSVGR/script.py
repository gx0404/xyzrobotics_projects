...
from xyz_env_manager.client import add_container_items, clear_container_items, clear_container_all_items,clear_planned_items
...
def execute(self, inputs, outputs, gvm):
    ...
    if vision_result.get("error"):
        raise XYZExceptionBase("10005", "获取视觉结果失败")   
