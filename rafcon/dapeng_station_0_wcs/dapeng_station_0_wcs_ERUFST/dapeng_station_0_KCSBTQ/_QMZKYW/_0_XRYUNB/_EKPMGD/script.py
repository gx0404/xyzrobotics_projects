...
def execute(self, inputs, outputs, gvm):
    ...
    for _id in workspace_ids:
        ...
        if check_robot_within_ws(rob, checker):
    ...
    if not len(check_collision):
        ...
        outputs["other_non_collision_workspace_ids"] = []
        ...
        outputs["other_non_collision_workspace_ids"] = [str(list(check_collision.keys())[0])]
    else: 
